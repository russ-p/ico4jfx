...
public class IconEntry {
	/**
	 * The width of the icon image in pixels. <tt>0</tt> specifies a width of 256
	 * pixels.
	 */
	public int bWidth;
	/**
	 * The height of the icon image in pixels. <tt>0</tt> specifies a height of 256
	 * pixels.
	 */
	public int bHeight;
	/**
	...
	/**
	 * Size of ICO data, which should be the size of (InfoHeader + AND bitmap + XOR
	 * bitmap).
	 */
